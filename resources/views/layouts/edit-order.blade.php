			...
			<!-- Modal Header -->
				...
				<div class="modal-body">
					...
					<div class="row mb-3 justify-content-between req-view">
						<div class="col">
							<strong>{{__('messages.name')}}:</strong> <p>{{$order->createdBy->name}}</p> 
						</div>
						<div class="col">
							<strong>{{__('messages.designation')}}:</strong><p> {{$order->createdBy->designation}}</p>
						</div>
						{{-- <div class="col">
							<strong>{{__('messages.status')}}:</strong> {{$order->status}}
						</div> --}}
						<div class="col">
							<strong>{{__('messages.department')}}:</strong><p> {{$order->createdBy->dept->name}}</p>
						</div>
						<div class="col">
							<strong>{{__('messages.date')}}:</strong><p> {{$order->req_date}}</p>
						</div>
