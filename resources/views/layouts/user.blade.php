                ...
                <tbody>
                    ...
                    <tr id="user-{{!empty($user->id)?$user->id:''}}">
                        ...
                        <td class="action">
                            ...
                            <button class="btn btn-info edit-user" data-id="{{!empty($user->id)?$user->id:''}}" data-toggle="modal" data-target="#edit_template_modal"><i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-danger delete-user" data-id="{{!empty($user->id)?$user->id:''}}" data-toggle="modal" data-target="#delete_template_modal"><i class="fas fa-trash-alt"></i>
                            </button>
                            @endif
                        </td>
                    </tr>
