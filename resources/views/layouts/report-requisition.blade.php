        ...
        <div class="card">
            <div class="card-header pv-card-hader">
                ...
                <div class="filter_form">
                    <form id="requisition_search_form" class="form form-inline" method="post"
                          action="{{url('/search/requisition')}}">
                        @csrf

                        <div class="form-group">
                            <select name="status_name" class="form-control" id="status_id" style="max-width: 141px;"
                                    required>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control date" style="max-width: 141px;"
                                   value="" name="from_date" placeholder="From Date"
                                   required>
                        </div>
                        <div class="form-group">
                            <input type="text" value="" style="max-width: 141px;"
                                   class="form-control date" name="end_date" placeholder="To Date" required>
                        </div>
                        <div class="form-group">
